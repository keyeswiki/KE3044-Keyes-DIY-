...
打开米思奇软件的官方网站 [https://www.keyesrobot.cn/zh-cn/latest/docs/Download_Center/Download_Center.html](https://www.keyesrobot.cn/zh-cn/latest/docs/Download_Center/Download_Center.html)，在页面可以看到Mixly软件各种版本

|image5|

在Mixly软件下，找到 2.0RC0，再点击 "**点击下载**" 按钮， Mixly2.0 RC网盘文件下载\ |image6|

这里是以Window系统为例来讲解，Mac系统和Liunx系统，可以参照。

|image53|

|image7|

资料有Window系统不同的版本可以供选择，这里以WIN10-x64版本为例，现在的电脑大部分都是WIN10的系统，点击下载自己所需的软件版本
...
.. |image53| image:: media/ABCD1235.png
.. |image54| image:: media/IMG_6726.jpg
.. |image55| image:: media/ABC.png
.. |image56| image:: media/CBA.png